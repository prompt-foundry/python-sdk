...
class RawMessageToolCallFunction(BaseModel):
    arguments: str
    """
    The arguments to call the function with, as generated by the model in JSON
    format. Note that the model does not always generate valid JSON, and may
...
class RawMessageToolCall(BaseModel):
    function: RawMessageToolCallFunction
...
class RawMessage(BaseModel):
    ...
    tool_calls: Optional[List[RawMessageToolCall]] = FieldInfo(alias="toolCalls", default=None)
...
class PromptConfiguration(BaseModel):
    ...
    """The prompt messages with variables replaced."""
    ...
    raw_messages: List[RawMessage] = FieldInfo(alias="rawMessages")
    """The original messages WITHOUT variables replaced."""
