...
from prompt-foundry-python-sdk import BaseModel, PromptFoundry, AsyncPromptFoundry
from prompt-foundry-python-sdk._response import (
    APIResponse,
    BaseAPIResponse,
    AsyncAPIResponse,
    BinaryAPIResponse,
...
from prompt-foundry-python-sdk._streaming import Stream
from prompt-foundry-python-sdk._base_client import FinalRequestOptions
...
def test_extract_response_type_direct_class_missing_type_arg() -> None:
    with pytest.raises(
        RuntimeError,
        match="Expected type <class 'prompt-foundry-python-sdk._response.AsyncAPIResponse'> to have a type argument at index 0 but it did not",
    ):
...
def test_response_parse_mismatched_basemodel(client: PromptFoundry) -> None:
    ...
    with pytest.raises(
        TypeError,
        match="Pydantic models must subclass our base model type, e.g. `from prompt-foundry-python-sdk import BaseModel`",
    ):
