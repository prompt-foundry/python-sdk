...
```bash
pip install git+ssh://git@github.com/prompt-foundry/python-sdk.git
```
...
You can release to package managers by using [the `Publish PyPI` GitHub action](https://www.github.com/prompt-foundry/python-sdk/actions/workflows/publish-pypi.yml). This requires a setup organization or repository secret to be set up.
